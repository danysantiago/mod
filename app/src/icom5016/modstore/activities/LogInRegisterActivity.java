...
public class LogInRegisterActivity extends MainInterfaceActivity implements
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.login_str).toUpperCase(l);
			case 1:
				return getString(R.string.register_str).toUpperCase(l);
			}
			return null;
		}
	}
