...
public class ProductListingAdapter extends ArrayAdapter<ProductSearching> {
		
		private ImageLoader imageloader;

		public ProductListingAdapter(Context context, JSONArray jsonArr) throws JSONException {
