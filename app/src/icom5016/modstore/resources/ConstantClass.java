...
public class ConstantClass {
	...
	public final static String[] DRAWER_USER_LIST = new String[]{"Home", "Categories", "My Items", "Sell Item", "Items for Sale", "Items Sold", "Settings", "About","Log Out"};
	public final static String[] DRAWER_ADMIN_LIST = new String[]{"Home", "Categories", "My Items", "Sell Item", "Items for Sale", "Items Sold", "Settings", "About","Log Out", "Admin Menu"};
