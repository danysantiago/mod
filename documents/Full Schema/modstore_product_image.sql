...
CREATE TABLE `product_image` (
  ...
  CONSTRAINT `fk_product_image_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2013-11-11 23:24:52
